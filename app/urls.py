...
urlpatterns = [
    ...
    path('admin/host-application/<int:application_id>/approve/', views.approve_host_application, name='approve_host_application'),
    path('admin/host-application/<int:application_id>/reject/', views.reject_host_application, name='reject_host_application'),
